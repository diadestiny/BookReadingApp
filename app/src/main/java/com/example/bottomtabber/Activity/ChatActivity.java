...
import com.example.bottomtabber.Control.ChatAdapter;
import com.example.bottomtabber.Control.Link;
import com.example.bottomtabber.Data.xx;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lj = new Link(this,getIntent().getStringExtra("ip_address"));
